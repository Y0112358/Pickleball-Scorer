...
import { initializeGame, handleRallyWin, undoLastAction, getActiveServerID } from './services/gameLogicLegacy';
        ...
        return (
            <div className="h-screen w-full bg-black text-white flex flex-col items-center justify-center p-6 gap-8 select-none">
                <div className="text-center">
                    ...
                    <p className="text-gray-400 text-sm tracking-widest uppercase">Mobile Scorer (Legacy)</p>
                </div>
                ...
                <div className="text-gray-500 text-xs mt-8">Legacy Version (Side-out Scoring)</div>
            </div>
        );
    }
